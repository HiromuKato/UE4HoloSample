...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_AllowedAxis_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AllowedAxis_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_AllowedAxis;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::NewProp_AllowedAxis_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::NewProp_AllowedAxis_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::NewProp_AllowedAxis = { "AllowedAxis", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUxtRotationAxisConstraint, AllowedAxis), Z_Construct_UEnum_UXTools_EUxtAxis, METADATA_PARAMS(Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::NewProp_AllowedAxis_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::NewProp_AllowedAxis_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::NewProp_AllowedAxis_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUxtRotationAxisConstraint_Statics::NewProp_AllowedAxis,
	...
	IMPLEMENT_CLASS(UUxtRotationAxisConstraint, 1536945674);
