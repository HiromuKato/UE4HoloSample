...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PivotComponent_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_PivotComponent;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AUxtTooltipActor_Statics::NewProp_PivotComponent_MetaData[] = {
		{ "Category", "Uxt Tooltip - Experimental" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AUxtTooltipActor_Statics::NewProp_PivotComponent = { "PivotComponent", nullptr, (EPropertyFlags)0x00400000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AUxtTooltipActor, PivotComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AUxtTooltipActor_Statics::NewProp_PivotComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AUxtTooltipActor_Statics::NewProp_PivotComponent_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AUxtTooltipActor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AUxtTooltipActor_Statics::NewProp_PivotComponent,
	...
	IMPLEMENT_CLASS(AUxtTooltipActor, 3426235804);
