...
// End Cross Module References
	...
	static UEnum* EUxtAxis_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_UXTools_EUxtAxis, Z_Construct_UPackage__Script_UXTools(), TEXT("EUxtAxis"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EUxtAxis(EUxtAxis_StaticEnum, TEXT("/Script/UXTools"), TEXT("EUxtAxis"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_UXTools_EUxtAxis_Hash() { return 3071642293U; }
	UEnum* Z_Construct_UEnum_UXTools_EUxtAxis()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_UXTools();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EUxtAxis"), 0, Get_Z_Construct_UEnum_UXTools_EUxtAxis_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_UXTools_EUxtAxisFlags_Hash() { return 4082604513U; }
	...
	uint32 Get_Z_Construct_UEnum_UXTools_EUxtOneHandRotationMode_Hash() { return 528709498U; }
