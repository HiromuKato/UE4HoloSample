...
static struct FScriptStruct_UXTools_StaticRegisterNativesFUxtButtonBrush
{
	...
	{
		UScriptStruct::DeferCppStructOps<FUxtButtonBrush>(FName(TEXT("UxtButtonBrush")));
	}
...
static struct FScriptStruct_UXTools_StaticRegisterNativesFUxtButtonAudioBrush
{
	...
	{
		UScriptStruct::DeferCppStructOps<FUxtButtonAudioBrush>(FName(TEXT("UxtButtonAudioBrush")));
	}
...
static struct FScriptStruct_UXTools_StaticRegisterNativesFUxtButtonVisualsBrush
{
	...
	{
		UScriptStruct::DeferCppStructOps<FUxtButtonVisualsBrush>(FName(TEXT("UxtButtonVisualsBrush")));
	}
